			...
			<div>
				<div className='row'>
					<div className='col-md-6 col-md-offset-3 finalScorePadding text-center'>
						...
						<img className='img-thumbnail scoreboard-image' alt='scoreboard-image' src='http://www.dazzleappz.com/wp-content/uploads/2014/04/iOS-Simulator-Screen-shot-Apr-13-2014-10.01.20-AM.png' />
					</div>
				</div>
				<div className='row'>
					<div className='col-md-6 col-md-offset-3 text-center'>
						<Link to='/'><button type='Submit' className='btn btn-primary' onClick={ event => this.resetScore() }>Home</button></Link>
					</div>
				</div>
			</div>
		);
